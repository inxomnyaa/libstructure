...
class StructureBlockUpdatePacket extends DataPacket
{
    ...
    protected function getStructureEditorData(): StructureEditorData
    {
        ...
        $result->structureSettings = $this->getStructureSettings1();
        //TODO 1.13 will probably add showInvisibleBlocks (bool)

        return $result;
    }

    protected function getStructureSettings1(): StructureSettings
    {
    ...
    protected function putStructureEditorData(StructureEditorData $data): void
    {
        ...
        $this->putStructureSettings1($data->structureSettings);
        //TODO 1.13 will probably add showInvisibleBlocks (bool)
    }

    protected function putStructureSettings1(StructureSettings $settings): void
    {
